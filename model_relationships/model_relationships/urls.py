...
# api/artists -> create the artist -> POST
# api/artists/18 -> details of one artist -> GET
# api/artists/18/delete -> details of one artist -> DELETE
# api/artists/18/update -> details of one artist -> PUT/PATCH
